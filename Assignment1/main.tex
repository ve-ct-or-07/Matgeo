...
\textbf{Question:}\\
Find the ratio in which the line segment joining the points $A\brak{1,-5}$ and $B\brak{-4,5}$ is divided by the $x$-axis. Also, find the coordinates of the point of division.
